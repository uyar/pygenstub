...
class FunctionNode(StubNode):
    ...
    def __init__(self, name: str, parameters: Sequence[Tuple[str, str, bool]], rtype: str, *, decorators: Optional[Sequence[str]] = ...) -> None: ...
    def get_code(self) -> List[str]: ...
class ClassNode(StubNode):
    name: str
    bases: Sequence[str]
    signature: Optional[str]
    def __init__(self, name: str, *, bases: Sequence[str], signature: Optional[str] = ...) -> None: ...
    def get_code(self) -> List[str]: ...
class StubGenerator(ast.NodeVisitor):
    ...
    def get_function_node(self, node: Union[ast.FunctionDef, ast.AsyncFunctionDef]) -> Optional[FunctionNode]: ...
